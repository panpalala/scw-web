			...
			<div class="col-sm-3 col-md-3 column">
					...
					<div class="col-md-12">
						<div class="thumbnail" style="border-radius: 0px;">
							...
							<div class="caption" style="text-align: center;">
								...
								<c:if test="${loginUser.authstatus == 0}">
									<span class="label label-danger" style="cursor: pointer;"
										onclick="window.location.href='${App_path}/toaccttype.html'">
										未实名认证
									</span>
								</c:if>
								<c:if test="${loginUser.authstatus == 1}">
									<span class="label label-primary" style="cursor: pointer;">
										实名认证中
									</span>
								</c:if>
								<c:if test="${loginUser.authstatus == 2}">
				...
				<div class="list-group">
					...
					<div class="list-group-item " style="cursor: pointer;"
						onclick="window.location.href='minecrowdfunding.jsp'">
